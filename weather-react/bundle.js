...
/***/ function(module, exports, __webpack_require__) {
	...
	var _weather = __webpack_require__(159);

	var _weather2 = _interopRequireDefault(_weather);

	var _es6Promise = __webpack_require__(163);
	...
	var API_TOKEN = "0596fe0573fa9daa94c2912e5e383ed3";
	...
	var SearchBar = (function (_React$Component) {
	   ...
	   _createClass(SearchBar, [{
	      ...
	      key: 'selectCurrentLocation',
	      value: function selectCurrentLocation() {
	         var _this2 = this;

	         navigator.geolocation.getCurrentPosition(function (position) {
	            _this2.showWeatherByLatitude(position.coords.longitude, position.coords.latitude);
	         });
	      }
	   }, {
	      key: 'showWeather',
	      value: function showWeather() {
	         ...
	         var location = this.refs["search-location-input"].value;
	         var url = 'http://api.openweathermap.org/data/2.5/weather?q=' + location + '&appid=' + API_TOKEN;

	         (0, _isomorphicFetch2.default)(url).then(function (response) {
	            return response.json();
	         }).then(function (data) {
	            _this3.props.onData(data);
	         });
	      }
	   }, {
	      key: 'showWeatherByLatitude',
	      value: function showWeatherByLatitude(longitude, latitude) {
	         var _this4 = this;

	         var url = 'http://api.openweathermap.org/data/2.5/weather?lat=' + latitude + '&lon=' + longitude + '&appid=' + API_TOKEN;

	         (0, _isomorphicFetch2.default)(url).then(function (response) {
	            return response.json();
	         }).then(function (data) {
	            _this4.props.onData(data);
	         });
	      }
	   }, {
	      key: 'render',
	      value: function render() {
	         return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	               ...
	               _react2.default.createElement(
	                  'span',
	                  { className: 'search-location-text' },
	                  'What\'s the weather like in',
	                  _react2.default.createElement('input', { id: 'search-location-input',
	            ...
	            _react2.default.createElement(
	               'div',
	               { className: 'search-location-button-group' },
	               _react2.default.createElement('button', { id: 'search-location-button',
	                  className: 'fa fa-search search-location-button search-button',
	                  onClick: this.showWeather.bind(this) }),
	               _react2.default.createElement('button', { id: 'geo-button',
	...
	var Wellcome = (function (_React$Component2) {
	   ...
	   function Wellcome() {
	      ...
	      return _possibleConstructorReturn(this, Object.getPrototypeOf(Wellcome).apply(this, arguments));
	   }
	   ...
	   _createClass(Wellcome, [{
	      ...
	      value: function render() {
	         return _react2.default.createElement(
	            'div',
	            { id: 'front-page-description', className: 'front-page-description middle' },
	            _react2.default.createElement(
	               'h1',
	               null,
	...
	var Info = (function (_React$Component3) {
	   ...
	   function Info(props) {
	      ...
	      var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(Info).call(this, props));
	   ...
	   _createClass(Info, [{
	      key: 'loadWeatherData',
	      value: function loadWeatherData(data) {
	         this.setState({
	            loaded: true,
	      ...
	      value: function getWindDirection(degree) {
	      ...
	      value: function render() {
	         return _react2.default.createElement(
	            'div',
	            { id: 'weather', className: 'weather middle', style: _weather2.default.info },
	            _react2.default.createElement(
	               'div',
	               { className: 'location', id: 'location' },
	               this.state.location
	            ),
	            _react2.default.createElement(
	               'div',
	               ...
	               _react2.default.createElement(
	                  'div',
	                  { id: 'temperature-info', className: 'temperature-info' },
	                  _react2.default.createElement(
	                     'div',
	                     { className: 'temperature', id: 'temperature' },
	                     this.state.temperature
	                  ),
	                  _react2.default.createElement(
	                     'div',
	                     { className: 'weather-description', id: 'weather-description' },
	               ...
	               _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                     'ul',
	                     { className: 'weather-info', id: 'weather-info' },
	                     _react2.default.createElement(
	                        'li',
	                        { className: 'weather-item humidity' },
	                        'Humidity: ',
	                        _react2.default.createElement(
	                           'span',
	                           { id: 'humidity' },
	...
	var WeatherApp = (function (_React$Component4) {
	   _inherits(WeatherApp, _React$Component4);

	   function WeatherApp(props) {
	      _classCallCheck(this, WeatherApp);

	      var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(WeatherApp).call(this, props));

	      _this7.state = { ready: false };
	      return _this7;
	   }
	   ...
	   _createClass(WeatherApp, [{
	      ...
	      value: function render() {
	         return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(SearchBar, { onData: this.showWeatherData.bind(this) }),
	            this.state.ready ? _react2.default.createElement(Info, { ref: 'info' }) : _react2.default.createElement(Wellcome, null)
	         );
	      }
	   }]);
	...
	_reactDom2.default.render(_react2.default.createElement(WeatherApp, null), document.getElementById("react-output"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    */
	    ...
	    if ("function" === 'function' && __webpack_require__(166)['amd']) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), (function() { return this; }()), __webpack_require__(164)(module)))
